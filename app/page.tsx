    ...
    <div className="lash-page">
      ...
      <section className="hero">
        <div className="container">
          <div>
            <p className="eyebrow">
              Lash lift &amp; tint · Bondi Junction &amp; Chatswood
            </p>
            <h1>
              Korean &amp; Keratin <em>Lash Lift</em>
            </h1>
            <p className="lede">
              A Korean lash lift or a keratin lash lift takes your own lashes,
              curls them from root to tip and sets the shape for 6 to 8 weeks.
              Lift from $105, or lift and tint from $125, in Bondi Junction and
              Chatswood.
            </p>
